...
-- 📓 일기
INSERT INTO diary (user_id, emotion_id, title, content, diary_date, is_public, created_at, updated_at)
VALUES (1, 1, '제목1' ,'오늘 날씨가 좋아서 기분이 좋았어요!', '2025-07-04', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO diary (user_id, emotion_id, title, content, diary_date, is_public, created_at, updated_at)
VALUES (2, 2, '제목2', '힘든 하루였지만 그래도 기록하자!', '2025-07-03', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Public 일기
INSERT INTO diary (user_id, emotion_id, title, content, diary_date, is_public, created_at, updated_at)
VALUES (2, 2, '제목3' ,'기쁜 하루였지만 그래도 기록하자!', '2025-07-07', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- ✅ 외래키 다시 켜기
